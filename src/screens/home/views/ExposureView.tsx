...
const ExposureText = ({ isBottomSheetExpanded }: { isBottomSheetExpanded: boolean }) => {
  ...
  return (
    <>
      ...
      <Text marginBottom="m" variant="smallText" color="lightText">{i18n.translate('Home.ExposureDetected.Body1')}</Text>
      {/* <ExposureDateView /> */}
      ...
      <Text marginBottom="m" variant="bodyDescription" color="lightText">{i18n.translate('Home.ExposureDetected.Body2')}</Text>
    </>
  );
};
